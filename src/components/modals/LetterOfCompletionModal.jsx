  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-6 overflow-y-auto w-full max-w-full">
      ...
      <div className="relative w-full max-w-4xl bg-dark-900 border border-slate-700/80 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden z-10 my-2 sm:my-4 max-h-[92vh] flex flex-col">
        ...
        <div className="p-4 sm:p-10 overflow-y-auto custom-scrollbar space-y-6 sm:space-y-8 bg-dark-950/70 font-sans">
          {/* Certificate Letter Container */}
          <div className="relative bg-gradient-to-b from-dark-900 via-dark-850 to-dark-900 border border-slate-700/90 rounded-2xl p-6 sm:p-10 shadow-xl space-y-8">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4 pb-6 border-b border-slate-800">
              <div className="space-y-1">
                <div className="text-xs font-semibold uppercase tracking-widest text-emerald-400 flex items-center gap-1.5">
                ...
                <p className="text-xs text-slate-400">
                  Internship Tenure: <span className="text-slate-200 font-medium">20.2.2026 – 20.08.2026 (Feb 2026 – Aug 2026)</span>
                </p>
              </div>

              <div className="text-right">
                <div className="text-xl font-extrabold tracking-tight text-white font-display flex items-center justify-end gap-1.5">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-slate-300 leading-relaxed">
              <p>
                This is to certify that <strong className="text-white font-semibold">{COMPLETION_LETTER.recipient}</strong> has successfully completed his internship with <strong className="text-white font-semibold">Devlupers</strong>. He served as a <strong className="text-emerald-300 font-semibold">“MERN Stack Intern”</strong> from <strong className="text-white font-semibold">20.2.2026 to 20.08.2026</strong>.
              </p>
            ...
            <div className="pt-6 border-t border-slate-800 grid grid-cols-1 sm:grid-cols-2 gap-6 items-end">
              {/* Sign-off */}
              <div className="space-y-3">
                <div className="text-xs text-slate-400">Sincerely,</div>
                <div className="space-y-0.5">
                  <div className="font-serif italic text-base sm:text-lg text-emerald-400 font-semibold tracking-wide">
                    Shivam Prajapati
                  </div>
              ...
              <div className="p-4 rounded-xl bg-dark-900 border border-slate-800/90 space-y-2 text-xs">
                ...
                <div className="space-y-1.5 text-slate-300">
                  <div className="flex items-center gap-2">
                    ...
                    <a href={`tel:${COMPLETION_LETTER.phone}`} className="hover:text-emerald-400 transition-colors">
                      {COMPLETION_LETTER.phone}
                    </a>
                  </div>
                  <div className="flex items-center gap-2">
                    <Mail className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                    <a href={`mailto:${COMPLETION_LETTER.contactEmail}`} className="hover:text-emerald-400 transition-colors">
                      {COMPLETION_LETTER.contactEmail} / {COMPLETION_LETTER.email}
                    </a>
                  </div>
                  <div className="flex items-center gap-2">
                    <Globe className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                    <a href={COMPLETION_LETTER.website} target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors">
        ...
        <div className="px-6 py-3.5 border-t border-slate-800 bg-dark-850 flex items-center justify-between text-xs text-slate-400 shrink-0">
          <div className="flex items-center gap-2">

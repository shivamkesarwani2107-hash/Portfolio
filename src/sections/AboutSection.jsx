          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="bg-dark-900 border border-slate-800 rounded-2xl sm:rounded-3xl p-5 sm:p-8 space-y-6 glow-card max-w-full">
              <div className="space-y-4 text-sm sm:text-base text-slate-300 leading-relaxed">
                ...
                <p className="text-slate-400">
                  Rather than relying on theoretical tutorials, I immersed myself in project-driven development — contributing to production platforms like <strong className="text-slate-200 font-semibold">AstroGanesh</strong> (a live astrology platform with payment & consultation workflows) and engineering full-stack systems like <strong className="text-slate-200 font-semibold">MegaMart</strong> (a grocery shopping platform with Redis caching & Razorpay) and a multi-tier <strong className="text-slate-200 font-semibold">Library Management System</strong> deployed across cloud platforms.
                </p>

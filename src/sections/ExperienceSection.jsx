        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="relative pl-6 sm:pl-8 border-l border-slate-800 space-y-8 ml-3 sm:ml-2">
              {EXPERIENCES.map((exp, idx) => (
                <div key={idx} className="relative group">
                  ...
                  <div className="bg-dark-900 border border-slate-800/90 hover:border-slate-700 rounded-2xl p-5 sm:p-6 space-y-4 glow-card max-w-full transition-all">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-dark-900 via-dark-850 to-dark-900 border border-emerald-500/30 hover:border-emerald-500/60 rounded-2xl p-6 space-y-4 glow-card relative overflow-hidden group">
                ...
                <div className="p-3 rounded-xl bg-dark-900/90 border border-slate-800 space-y-1 text-xs text-slate-400">
                  <div className="flex items-center justify-between">
                    <span>Authorized Signatory:</span>
                    <span className="text-slate-200 font-medium">{COMPLETION_LETTER.signatory} ({COMPLETION_LETTER.designation})</span>
                  </div>
                  <div className="flex items-center justify-between">
